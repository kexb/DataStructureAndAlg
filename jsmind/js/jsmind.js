...
; (function ($w) {
    ...
    jm.view_provider.prototype = {
        ...
        show_lines: function () {
		  ...
		  show_lines2: function (disx,disy) {
			 this.clear_lines();
            var nodes = this.jm.mind.nodes;
            var node = null;
            var pin = null;
            ...
            for (var nodeid in nodes) {
			 ...
			 var ctx =  _jm.view.graph.canvas_ctx//this.canvas_ctx;
            ctx.strokeStyle = _jm.view.opts.line_color//this.opts.line_color;
            ctx.lineWidth = _jm.view.opts.line_width //this.opts.line_width;
            ctx.lineCap = 'round';

             _jm.view.graph._bezier_to(ctx,
                pin.x + disx,
                pin.y + disy, 
                pout.x + disx,
                pout.y + disy);
